...
const (
	...
	// PrivilegedLabel marks test pods that require the anyuid and privileged SCCs.
	// The controller uses it to decide whether the pod needs a ServiceAccount with
	// elevated SCC access.
